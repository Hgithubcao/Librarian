<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LibrarianDeleteStudent.aspx.cs" Inherits="LibrarianDeleteStudent" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="DeleteStudent" runat="server" BackColor="#993333" BorderStyle="None" Font-Overline="False" Font-Underline="False" ForeColor="White" Height="36px" Text="删除用户" Width="103px" OnClick="DeleteStudent_Click" />
        ...
        <asp:Label ID="Label7" runat="server" style="position:absolute;top:70px;left:120px"></asp:Label>
